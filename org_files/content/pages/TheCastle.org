...
#+OPTIONS: num:t tags:nil todo:nil H:2 toc:t author:nil date:nil d:nil title:t
...
* TODO Check formatting in "Round Edale Walk or "Who Went Where and Who Said What?"".
* TODO Rotate image of "Salt Cellar".
* TODO Rotate image "Mt Blanc de Tacul".
* TODO Formatting in "La Grande Epique de la Petite Dent de Veisivi".
* TODO Rotate image "Chris Wright...".
* TODO Rotate image "Summit of Ben Avon".
* TODO Sets the default options for the chapter files.
* TODO Eastern Edges Walk photo should be landscape.
* TODO TWO WEEKS OLDER, YEARS WISER photo should be landscape.
* TODO ROUTE MAJOR photo should be landscape.
* TODO PRINCE CHARLIE'S CASTLE TRAMP - photo should be landscape.
* TODO A Three Second Route - photo should be landscape.
* TODO Grit Biter not formatted as verse
...
#+INCLUDE: ./Chronological_list_of_officers.org
